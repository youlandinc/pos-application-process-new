...
export const GroundProperty = types
  .model({
    values: types.model({
...
export type IGroundProperty = Instance<typeof GroundProperty>;
export type SGroundProperty = SnapshotOut<typeof GroundProperty>;
