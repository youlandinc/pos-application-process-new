...
export const MortgageFinancialSituation = types
  .model({
  ...
  .actions((self) => {
    return {
      ...
      getPostData(): Variable<MortgageFinancialSituationData> {
        const {
          savingAccount,
          retirementAccount,
          stockAndBonds,
      ...
      injectServerData(value: MortgageFinancialSituationData) {
        const {
          savingAccount,
          retirementAccount,
          stockAndBonds,
...
export type IMortgageFinancialSituation = Instance<
  typeof MortgageFinancialSituation
>;
export type SMortgageFinancialSituation = SnapshotOut<
  typeof MortgageFinancialSituation
>;
