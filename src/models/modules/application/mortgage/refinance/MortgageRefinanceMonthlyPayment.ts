...
export type IMRPaymentLoan = Instance<typeof PaymentLoan>;
export type SMRPaymentLoan = SnapshotIn<typeof PaymentLoan>;
...
export const MortgageRefinanceMonthlyPayment = types
  ...
  .actions((self) => ({
    ...
    updateLoanList(paymentData: SMRPaymentLoan, idx: number) {
    ...
    addLoan(paymentData: SMRPaymentLoan) {
      if (paymentData.isPrimary) {
...
export type IMRMonthlyPayment = Instance<
  typeof MortgageRefinanceMonthlyPayment
>;
export type SMRMonthlyPayment = SnapshotIn<
  typeof MortgageRefinanceMonthlyPayment
>;
