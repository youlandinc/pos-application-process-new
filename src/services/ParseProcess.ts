...
interface VariableMap {
  _startingData: StartingData & BridgeStartingData;
  _propertyNewData: PropertyNewData;
  _clientAppProgressData: ApplicationProcessSnapshot;
  ...
  _borrowerFinancialData: FinancialSituationData;
...
export class ParseProcess {
  ...
  >(key: K, variableName: VariableName): void {
    ...
    const findR = utils.findSpecificVariable<T>(
      variableName,
  ...
  get startingData(): Maybe<StartingData & BridgeStartingData> {
  ...
  get propertyNewData(): PropertyNewData {
  ...
  get clientAppProgressData(): Maybe<ApplicationProcessSnapshot> {
    this.findAndAssignVariants(
      '_clientAppProgressData',
      VariableName.clientAppProgress,
    );
  ...
  get borrowerFinancialData(): Maybe<FinancialSituationData> {
    this.findAndAssignVariants(
  ...
  public get productType(): SceneType {
...
export class ParseProcessGridData extends ParseProcess {
  ...
  get processGridData(): IProcessGridData {
    return {
      ...
      loanAmount: utils.formatDollar(this.getLoanAmount),
