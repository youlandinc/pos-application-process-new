...
export interface FixedApplicationProcessSnapshot {
  ...
  creditScore: {
    state: FixedAndFlipCreditScoreState;
  };
  state: FixedAndFlipPurchaseState | FixedAndFlipRefinanceState;
}

export interface FixedStartingData {
...
export interface FixedCoBorrowerCondition {
  isCoBorrower: boolean | undefined;
}

export interface FixedPurchaseEstimateRateData {
...
export interface FixedRefinanceEstimateRateData {
