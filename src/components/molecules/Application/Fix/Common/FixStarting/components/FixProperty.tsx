...
import { IFixProperty } from '@/models/application/fix';
...
interface FixPropertyProps {
  property: IFixProperty;
}

export const FixProperty: FC<FixPropertyProps> = observer((props) => {
