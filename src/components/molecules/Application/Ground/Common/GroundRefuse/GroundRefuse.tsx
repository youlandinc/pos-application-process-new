...
export const GroundRefuse: FC<{ nextStep: () => void }> = observer(
  ({ nextStep }) => {
    const {
      applicationForm: {
        formData: {
    ...
    return (
      <>
        <StyledFormItem
          ...
          tip={
            "We're sorry but there is no ground up construction loan product available for you for the time being based on your credit score. Should you require additional assistance, email us at borrow@youland.com or call toll free at 1-833-968-5263."
          }
          tipSx={{ mb: 0 }}
        >
          <Box
