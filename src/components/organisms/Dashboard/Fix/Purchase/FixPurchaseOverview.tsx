...
import { FPOverviewSummaryData, HttpError, UserType } from '@/types';
...
export const FixPurchaseOverview: FC = observer(() => {
  ...
  const { loading } = useAsync(async () => {
    ...
    return await _fetchOverviewLoanSummary<FPOverviewSummaryData>(
